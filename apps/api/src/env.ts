...
const rawSchema = z.object({
  ...
  for (const key of ["DATABASE_URL", "CORS_ORIGIN", "ADMIN_BOOTSTRAP_TOKEN", "SESSION_COOKIE_NAME", "SESSION_DAYS", "CLOUDINARY_CLOUD_NAME", "CLOUDINARY_API_KEY", "CLOUDINARY_API_SECRET", "CLOUDINARY_FOLDER"] as const) {
