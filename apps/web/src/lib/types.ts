...
export type MediaPlacement = "HOME_HERO"|"PROJECT_GALLERY"|"APARTMENT_GALLERY"|"APARTMENT_CATALOG"|"APARTMENT_PLAN"|"FLOOR_PLAN"|"EXTERIOR"|"INTERIOR"|"VIRTUAL_TOUR"|"DOCUMENTATION";
export type MediaType = "IMAGE"|"VIDEO"|"DOCUMENT"|"FLOOR_PLAN"|"RENDER"|"VIRTUAL_TOUR";
export type MediaAssetDto={id:string;title:string;alt:string|null;caption:string|null;secureUrl:string;thumbnailUrl:string|null;originalFilename:string|null;cloudinaryResourceType:"image"|"video"|"raw";placement:MediaPlacement;type:MediaType;isPublished:boolean;isCover:boolean;sortOrder:number;format:string|null;width:number|null;height:number|null;durationSeconds:number|null;bytes:number|null;apartment?:{code:string;slug:string}|null};
...
export type PublicApartmentDto=Omit<AdminApartmentDto,"id"|"sourceLocked">&{media:MediaAssetDto[];rooms?:ApartmentRoomDto[]};
