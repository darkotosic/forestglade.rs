...
export type MediaAssetDto={id:string;title:string;alt:string|null;caption:string|null;secureUrl:string;thumbnailUrl:string|null;placement:MediaPlacement;type:MediaType;isPublished:boolean;isCover:boolean;sortOrder:number;originalFilename?:string|null;width?:number|null;height?:number|null;bytes?:number|null;apartment?:{code:string;slug:string}|null};
