export const FLOOR_LABELS = ["Suteren", "Prizemlje", "I sprat", "II sprat", "Povučeni sprat"] as const;
...
export const OFFICIAL_APARTMENTS: OfficialApartment[] = officialApartmentRows.map(([code, floor, officialType, marketArea]) => ({
  code,
